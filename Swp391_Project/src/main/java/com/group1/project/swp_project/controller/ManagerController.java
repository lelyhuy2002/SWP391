...
@Tag(
    name = "3.Management (Manager)",
    description = "APIs for Manager to manage staff and consultants")
@RestController
...
public class ManagerController {
  ...
  @PutMapping("/staff/{id}")
  public ResponseEntity<UserSummary> updateStaff(
      @PathVariable int id, @RequestBody UpdateProfileRequest request) {
  ...
  public ResponseEntity<UserSummary> updateConsultant(
      @PathVariable int id, @RequestBody UpdateProfileRequest request) {
    return ResponseEntity.ok(userManagementService.updateProfile(id, request));
  }
  ...
  public ResponseEntity<UserSummary> updateCustomer(
      @PathVariable int id, @RequestBody UpdateProfileRequest request) {
    return ResponseEntity.ok(userManagementService.updateProfile(id, request));
  }
