...
@Tag(
    ...
    description = "APIs for User Registration, Login, and Verification")
@RestController
...
public class AuthController {
  ...
  @ApiResponse(
      responseCode = "201",
      description = "User registration initiated. Please check your email for verification.")
  @ApiResponse(
      responseCode = "400",
      description = "Bad Request - Invalid input or user/email already exists.")
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Bad Request - Invalid credentials or account not enabled.")
  @PostMapping("/login")
  ...
  @Operation(
      ...
      description = "Activates a user account using the verification code from email.")
  @ApiResponse(responseCode = "200", description = "Account verified successfully.")
  @ApiResponse(
      responseCode = "400",
      description = "Bad Request - Invalid email or code, or token expired.")
  ...
  @Operation(
      ...
      description = "Sets a new password for the user using a valid code.")
  ...
  @ApiResponse(
      responseCode = "400",
      description = "Bad Request - No token found or error during logout")
  @PostMapping("/logout")
  public ResponseEntity<?> logoutUser(HttpServletRequest request, HttpServletResponse response) {
    try {
      ...
      if (token == null) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("No token found in cookies");
      }
